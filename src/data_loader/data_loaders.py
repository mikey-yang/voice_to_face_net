...
class SpeakerID(BaseDataLoader):
    ...
    """
    def __init__(self, data_dir, specgrams_dir, root_path, file_extension, batch_size, shuffle=True, validation_split=0.0, num_workers=1, training=True):
        self.data_dir = data_dir 
        self.root_path = root_path
        self.file_extension = file_extension
        self.specgrams_dir = specgrams_dir
        self.dataset = VoxCeleb(self.data_dir, self.specgrams_dir, self.root_path, self.file_extension, "train")
    ...
    def split_validation(self):
        val_dataset = VoxCeleb(self.data_dir, self.specgrams_dir, self.root_path, self.file_extension, "val")
